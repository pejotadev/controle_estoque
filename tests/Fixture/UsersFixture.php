...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'email' => ['type' => 'string', 'length' => 32, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'roles_id' => 1,
                'created' => '2020-08-21 00:10:55',
                'modified' => '2020-08-21 00:10:55',
                'status' => 1,
            ],
        ];
        parent::init();
